...
{
    return ImGuizmo::ViewManipulate(view,length,ConvertToCPP_ImVec2(position),ConvertToCPP_ImVec2(size),backgroundColor);
}
...
{
    return ImGuizmo::ViewManipulate(view,projection,operation,mode,matrix,length,ConvertToCPP_ImVec2(position),ConvertToCPP_ImVec2(size),backgroundColor);
}
